...
const FALLBACK_PROJECTS = [
  ...
  { id: 'uniflow-backend', github_repo_url: 'https://github.com/KERNEL-FORGE-G/uniflow-backend', display_name: 'UniFlow Backend', description: 'API REST NestJS, logique métier, PostgreSQL/Prisma et endpoints de synchronisation.', featured: true, category: 'cli', tags: ['NestJS', 'PostgreSQL'], image_url: '/projects/uniflow-backend.png' },
  { id: 'uniflow-backend2', github_repo_url: 'https://github.com/KERNEL-FORGE-G/uniflow-backend2', display_name: 'UniFlow Backend 2', description: 'Second backend UniFlow destiné aux comptes qui ne sont pas encore liés à une université.', featured: false, category: 'cli', tags: ['TypeScript', 'API'], image_url: '/projects/uniflow-backend2.png' },
  { id: 'kernel-store', github_repo_url: 'https://github.com/KERNEL-FORGE-G/kernel-store', display_name: 'Kernel Store', description: 'Projet open source de l’écosystème Kernel Forge, actuellement en construction par le collectif.', featured: false, category: 'web', tags: ['TypeScript', 'prototype'], image_url: '/projects/kernel-store.png' },
  { id: 'dino-project', github_repo_url: 'https://github.com/KERNEL-FORGE-G/Dino_project', display_name: 'Dino Project', description: 'Projet scolaire de ICT202 : une réinterprétation du jeu Dino de Chrome avec une touche personnelle.', featured: false, category: 'other', tags: ['TypeScript', 'projet scolaire'], image_url: '/projects/dino-project.png' },
]
