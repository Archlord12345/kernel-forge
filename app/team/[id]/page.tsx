    ...
    <main className="min-h-screen bg-[#17120f] text-[#fffaf0]">
      ...
      <section className="container mx-auto grid max-w-6xl gap-6 px-4 py-16 lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="space-y-6">
          ...
          {profile.languages?.length ? <section className="rounded-[1.5rem] border border-[#fffaf0]/10 bg-[#241b16] p-7 md:p-9"><div className="flex items-center gap-3"><span className="text-xl text-[#ff7626]">◎</span><h2 className="text-2xl font-black">Langues</h2></div><div className="mt-6 flex flex-wrap gap-2">{profile.languages.map((language) => <span key={language} className="rounded-full border border-[#56d5a0]/25 bg-[#56d5a0]/10 px-3 py-1.5 text-sm text-[#b5f4d2]">{language}</span>)}</div></section> : null}
          {profile.interests?.length ? <section className="rounded-[1.5rem] border border-[#fffaf0]/10 bg-[#241b16] p-7 md:p-9"><div className="flex items-center gap-3"><span className="text-xl text-[#ff7626]">✦</span><h2 className="text-2xl font-black">Centres d’intérêt</h2></div><div className="mt-6 flex flex-wrap gap-2">{profile.interests.map((interest) => <span key={interest} className="rounded-full border border-[#ff7626]/25 bg-[#ff7626]/10 px-3 py-1.5 text-sm text-[#ffd1b5]">{interest}</span>)}</div></section> : null}
